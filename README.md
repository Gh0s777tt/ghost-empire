...
| **Jakość** | Vitest **4** (**454 testów**) · ESLint **9** (flat config) · GitHub Actions CI · Dependabot · GitGuardian |
...
| **DX** | `strict` TS · **0 `as any`** w `src` · ESLint flat config w CI · Vitest **454 testów** (+ integracyjne na realnym Postgresie w CI) · Dependabot · dokumentacja na bieżąco |
