"use client";
// src/components/kasyno/boards/games.tsx
...
import { PLINKO_MULTS_UI, PLINKO_ROWS_UI, plinkoBucketColor, US_WHEEL, SEG, HEX, rcolor, pocketLabel, polar, annulus, SLOT_FACES, CELL, STRIP } from "../logic";
