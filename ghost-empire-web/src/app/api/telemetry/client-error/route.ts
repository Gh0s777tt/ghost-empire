...
// uncaught errors here and we console.error them — which lands in Vercel's function
// logs. Hard rate-limit per IP; payload truncated; no auth (errors happen for
// guests too); nothing is stored in the DB.
