...
# docs:i18n · docs:i18n:dup · docs:brand · docs:roadmap · docs:rls · docs:changelog · unit tests · integration tests) plus an optional production
...
gate "docs:changelog"    npm run --silent docs:changelog
